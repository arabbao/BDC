...
用户已经开始上传，一共上传120次左右，偶尔会因为文件内容格式问题上传失败。
...
| 任务名称 | 运行时间 | 说明 
| --- | --- | --- |
|Davi-Upload-File-Parser  |	14d 2h 50m 22s	davi |文件上传解析任务|
|f6-spi-log-task| 	25d 1h 14m 30s|	spi生产数据解析至DB|
|DeviceDataProcessing |  	25d 1h 14m 30s	| |
|AutoCloseAlarm| 	25d 1h 14m 30s| |	
